...
var User = function () {
    var _classDecorators = [(0, sequelize_typescript_1.Table)({ tableName: 'users' })];
    ...
    var User = _classThis = /** @class */ (function (_super) {
        ...
        function User_1() {
            ...
            _this.image_url = (__runInitializers(_this, _email_extraInitializers), __runInitializers(_this, _image_url_initializers, void 0));
            __runInitializers(_this, _image_url_extraInitializers);
            return _this;
        }
        return User_1;
    }(_classSuper));
    ...
    (function () {
        ...
        _image_url_decorators = [(0, sequelize_typescript_1.Column)({
                type: sequelize_typescript_1.DataType.STRING,
            })];
